...
struct TimerView: View {
    ...
    // 스누즈
    @State private var isSnooze = false
    ...
    private func timerFinished() {
        ...
        if isSnooze || wakeStyle.category == .hwadeuljjak {
            // 스누즈 알람 → 무조건 화들짝 / 원래 화들짝 선택
            isSnooze = false
